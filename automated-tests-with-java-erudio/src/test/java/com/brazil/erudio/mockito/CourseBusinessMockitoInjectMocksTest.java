...
import com.brazil.erudio.business.CourseBusiness;
...
class CourseBusinessMockitoInjectMocksTest {
    ...
    void testDeleteCoursesNotRelatedToSpring_UsingMockitoVerify_Should_CallMethod_deleteCourseVersionTwo() {
        ...
        String architectureCourse = "Arquitetura de Microsservicos do 0 com ASP.NET, .NET 6 e C#";
        String restSpringCourse = "REST API's RESTFul do 0 a AWS com Spring Boot 3 Java e Docker";
